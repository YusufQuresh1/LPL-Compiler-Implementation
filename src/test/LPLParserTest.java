...
class LPLParserTest {
    ...
    private static Stream<String> testFilePathsA() {
        return test.Utils.testFilePaths("data/tests/parserA");
    }

    private static Stream<String> testFilePathsB() {
        return test.Utils.testFilePaths("data/tests/parserB");
    }

    private static Stream<String> testFilePathsC() {
        return test.Utils.testFilePaths("data/tests/parserC");
    }
}